...
namespace Dissonance.Integrations.MirrorIgnorance
{
        ...
        : BaseClient<MirrorIgnoranceServer, MirrorIgnoranceClient, MirrorConn>
    {
        ...
        public override void Connect()
        {
            ...
            {
                NetworkClient.RegisterHandler<DissonanceNetworkMessage>(OnMessageReceived);
            }
            else
        ...
        public override void Disconnect()
        {
            ...
            if (!_network.Mode.IsServerEnabled())
            {
                NetworkClient.RegisterHandler<DissonanceNetworkMessage>(MirrorIgnoranceCommsNetwork.NullMessageReceivedHandler);
            }
        ...
        private bool Send(ArraySegment<byte> packet, byte channel)
        {
            ...
            return NetworkClient.connection.Send(new DissonanceNetworkMessage(packet), channel);
        }
        #endregion
    }
}
